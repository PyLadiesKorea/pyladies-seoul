...
5. **API design**: Create RESTful API specifications.
   ...
   - Use HTTP methods (GET, POST, PUT, DELETE) instead of URL verbs
...
- Resource-based URL design (avoid verbs in URLs)
...
## API Specification
### Endpoint Design
- Resource-based URL structure (e.g., /users, /posts, /files)
